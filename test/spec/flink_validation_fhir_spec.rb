...
describe 'Flink Validation FHIR Job' do
  ...
  before(:all) do
    ...
    #Upload Jar File
    @test_jar_id = @flink_helper.upload_jar_from_dir("hri-flink-validation-fhir-#{ENV['BRANCH_NAME']}.jar", File.join(File.dirname(__FILE__), '../../validation/build/libs'), @flink_api_oauth_token, /hri-flink-validation-fhir-.+.jar/)
